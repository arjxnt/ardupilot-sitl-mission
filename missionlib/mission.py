...
def fly_search_pattern(vehicle, waypoints, cfg: MissionConfig, flight_log):
    """
...
def orbit_target(vehicle, cfg: MissionConfig, flight_log):
    log_event(
...
def run_mission(vehicle, waypoints, cfg: MissionConfig) -> MissionResult:
    ...
    detection = fly_search_pattern(vehicle, waypoints, cfg, flight_log)
    ...
    if detection is not None:
        ...
        orbit_target(vehicle, cfg, flight_log)
    else:
